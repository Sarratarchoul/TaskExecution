...
public class TaskExecution extends AbstractBaseEntity {
	...
	public TaskExecution(String taskConfigName,long durationInSeconds,TaskExecutionStatus status,String transportedFiles
	,String message,boolean emailErrorSent, Date startDate, Date endDate,boolean inProgressCopyDetected, int nbrCheckInProgressCopy) {
		super();
